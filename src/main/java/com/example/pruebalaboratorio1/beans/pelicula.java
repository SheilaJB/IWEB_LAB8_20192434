...
public class pelicula {
    ...
    private  boolean validadorPelicula;

    public boolean isPremioOscar() {
        return premioOscar;
    }

    public boolean isValidadorPelicula() {
        return validadorPelicula;
    }

    public void setValidadorPelicula(boolean validadorPelicula) {
        this.validadorPelicula = validadorPelicula;
    }
